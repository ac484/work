// 本元件為主題與顏色配置面板
// 功能：切換主題色、表面色、深色模式，動態套用 PrimeNG 主題
// 用途：全域主題設定與切換 UI
...
@Component({
  ...
  template: `
    <div
      class="absolute top-32 right-0 w-16 p-4 bg-white dark:bg-surface-900 rounded-md shadow-lg border border-surface-200 dark:border-surface-700 origin-top z-50"
    >
